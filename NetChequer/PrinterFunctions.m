...
{
    NSUInteger commandSize = [commandsToPrint length];
    ...
    @try
    {
        ...
        {
            uint32_t remaining = (uint32_t)commandSize - totalAmountWritten;
            NSUInteger amountWritten = [starPort writePort:dataToSentToPrinter :totalAmountWritten :remaining];
...
+ (void)PrintSampleReceipt3InchWithPortname:(NSString *)portName portSettings:(NSString *)portSettings
{
    ...
    [commands appendData:[@"Punkalookavile\r\n" dataUsingEncoding:NSASCIIStringEncoding]];

    [commands appendData:[@"665-A Hades Way\r\nStyx, Olympus 00000\r\n\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    ...
    [commands appendData:[@"300678566 \x09  DEATH ON A STICK\x09         10.99\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    
    [commands appendData:[@"300692003 \x09  RIGHT ARM SALAD\x09         29.99\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    
    [commands appendData:[@"300651148 \x09  OLD PANTHER ROCKS\x09         29.99\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    
    [commands appendData:[@"300642980 \x09  DOUBLE-DOUBLE\x09         49.99\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    
    [commands appendData:[@"300638471 \x09  BRAAAIIINNNNNS\x09         35.99\r\n\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    ...
    [commands appendData:[@"ARE NOT FUCKING OFFERED\x1b\x2d\x00\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
    
    [commands appendData:[@"no soul-back guarantees here\r\n\r\n" dataUsingEncoding:NSASCIIStringEncoding]];
...
{
    NSString *textToPrint = @"        Punkalookavile Final Foods\r\n"
							 "              665-A Hades Way\r\n"
                         	 "      (Just across from the Entrance)\r\n"
                             "            Styx, Olympus 00000\r\n"
                             "\r\n" 
                             "Date: 12/1/9999          Time: 3:33 PM\r\n"
                             "--------------------------------------\r\n"
                             "SALE\r\n"
                             "SKU            Description       Total\r\n" 
                             "300678566      DEATH ON A STICK   4.99\n"
                             "300692003      CYANIDE FRIES      9.99\n"
                             "300651148      BAMBI BURGER       9.99\n"
                             "300642980      BROKEN RIBS        9.99\n"
                             "300000000      BRAAAAAAIIINNS     5.99\n"
                             "\n"
                             "Subtotal                         40.95\r\n"
                             "Tax                               0.00\r\n"
                             "--------------------------------------\r\n"
...
{
    size_t commandSize = [commandsToPrint length];
    unsigned char *dataToSentToPrinter = (unsigned char *)malloc(commandSize);
    [commandsToPrint getBytes:dataToSentToPrinter];
    ...
    @try
    {
        ...
        while (totalAmountWritten < commandSize)
        {
            size_t remaining = commandSize - totalAmountWritten;
            size_t amountWritten = [starPort writePort:dataToSentToPrinter :totalAmountWritten :(uint32_t)remaining];
            totalAmountWritten += amountWritten;
...
+ (SMBluetoothManager *)loadBluetoothSetting:(NSString *)portName portSettings:(NSString *)portSettings {
    UIAlertView *alert = [[[UIAlertView alloc] initWithTitle:@"Error" message:@"" delegate:nil cancelButtonTitle:nil otherButtonTitles:@"OK", nil] autorelease];
